...
CORS_ALLOWED_ORIGINS="${CORS_ALLOWED_ORIGINS:-http://localhost:3000,http://localhost:3002,http://192.168.15.190:3002,https://stickerline-fe-917214899974.asia-southeast1.run.app,https://stickerline-fe-to5rvfgg5a-as.a.run.app}"
...
for env_key in \
  ...
  ENABLE_PUBSUB_WORKER_ENDPOINT; do
